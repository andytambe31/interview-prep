...
export const studyPlan = [
  ...
  { phase: 'DSA sprint · ~7 days', day: 'Day 2', theme: 'Trees — harder (with Andy)', items: 'Serialize/Deserialize · All Nodes Distance K · Binary Tree Max Path Sum · Zigzag Level Order. Pair with Andy on the tricky recursion & DFS state.' },
  ...
  { phase: 'DSA sprint · ~7 days', day: 'Day 4', theme: 'Graphs — topo sort & union-find (with Andy)', items: 'Course Schedule I/II · Alien Dictionary · Critical Connections · Word Ladder. Work the harder graph patterns with Andy.' },
