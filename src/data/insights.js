...
export const studyPlanIntro =
  'Tuned to where Raveena is now: strong on arrays, prefix-sums, and the common array questions, weakest on the harder round-2 material — trees and graphs. So the 7-day sprint front-loads trees & graphs, covers the other harder patterns next (heaps, DP, binary search), and treats the array family as a quick end-of-sprint refresh. Then the final ~4 days go to the 8–10 STAR story bank, LLD/OOD, résumé dive-deep, and mocks. Coding stays single-focus — no parallel work during the sprint.'

export const studyPlan = [
  { phase: 'DSA sprint · ~7 days', day: 'Day 1', theme: 'Trees — fundamentals & traversals', items: 'Level Order · Right Side View · LCA of a Binary Tree · Subtree of Another Tree · Validate BST. Priority area — this is the round-2 bar.' },
  { phase: 'DSA sprint · ~7 days', day: 'Day 2', theme: 'Trees — harder', items: 'Count Good Nodes · Construct from Preorder+Inorder · All Nodes Distance K · Zigzag · Binary Tree Max Path Sum · Serialize/Deserialize. Nail the “return a value up vs update a global” pattern.' },
  { phase: 'DSA sprint · ~7 days', day: 'Day 3', theme: 'Graphs — grids & BFS/DFS', items: 'Number of Islands · Rotting Oranges · Word Search · Surrounded Regions · Shortest Path in Binary Matrix.' },
  { phase: 'DSA sprint · ~7 days', day: 'Day 4', theme: 'Graphs — topo sort & union-find', items: 'Course Schedule I/II · Alien Dictionary · Redundant Connection · Number of Connected Components · Word Ladder.' },
  { phase: 'DSA sprint · ~7 days', day: 'Day 5', theme: 'Heaps & Tries', items: 'K Closest Points · Top K Frequent Words · Merge k Sorted Lists · Find Median from Data Stream; Implement Trie · Search Suggestions System · Word Search II.' },
  { phase: 'DSA sprint · ~7 days', day: 'Day 6', theme: 'DP, Binary Search & Intervals', items: 'Coin Change · Word Break · Jump Game · House Robber; Koko · Search in Rotated Array · Search a 2D Matrix II; Merge Intervals · Meeting Rooms II.' },
  { phase: 'DSA sprint · ~7 days', day: 'Day 7', theme: 'Strengths refresh + Design + timed mix', items: 'Quick confirm strengths: Two Sum · Product Except Self · 3Sum · Longest Substring · Trapping Rain Water; Linked List pass (Reverse · Merge Two · Add Two Numbers · Copy Random List); LRU Cache. Then a timed mixed set weighted to trees/graphs.' },
